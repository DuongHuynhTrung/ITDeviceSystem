    ...
    <body>
        ...
        <div class="col-sm-12 staff-navbar justify-content-center text-center">
            <form action="MainController">
                ...
                <button class="btn btn-primary" type="submit" name="action" value="LoadReturnedRequest">Returned Request</button></a>
        ...
        <div class="table-wapper col-sm-12">
            <table class="table text-center">
                ...
                <tbody>
                    <c:forEach var="request" varStatus="counter" items="${requestScope.LIST_RETURNED_REQUEST}">
                        <tr>
                            <td>${request.id}
                            </td>

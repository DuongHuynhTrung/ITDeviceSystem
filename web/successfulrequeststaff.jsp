                ...
                <form action="MainController" method="POST">
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <li>
                            ...
                            <button class="btn" type="submit" name="action" value="SearchRequestByUserInSuccessfulRequest"/>Search
                        </li>
                    </ul>
                </form>
                ...
                <form action="MainController" method="POST">
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <li>
                            ...
                            <button class="btn" type="submit" name="action" value="SearchRequestByDateInSuccessfullRequest"/>Search
                        </li>
                    </ul>
                </form>

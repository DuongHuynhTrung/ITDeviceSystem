    ...
    <body>
        ...
        <div class="col-sm-12 staff-navbar justify-content-center text-center">
            <form action="MainController">
                ...
                <button class="btn btn-primary" type="submit" name="action" value="LoadApprovedRequest">Approved Request</button></a>
                ...
                <form action="MainController" method="POST">
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <li>
                            ...
                            <button class="btn" type="submit" name="action" value="SearchRequestByUserInApproveRequest"/>Search
                        </li>
                    </ul>
                </form>
                ...
                <form action="MainController" method="POST">
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <li>
                            ...
                            <button class="btn" type="submit" name="action" value="SearchRequestByDateInApproveRequest"/>Search
                        </li>
                    </ul>
                </form>
        ...
        <div class="table-wapper col-sm-12">
            <table class="table text-center">
                ...
                <tbody>
                    <c:forEach var="request" varStatus="counter" items="${requestScope.LIST_APPROVED_REQUEST}">
                    <form action="MainController" method="POST">

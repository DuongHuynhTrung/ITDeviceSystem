                ...
                <form action="MainController" method="POST">
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <li>
                            ...
                            <button class="btn" type="submit" name="action" value="SearchRequestByUserInProcessRequest"/>Search
                        </li>
                    </ul>
                </form>
                ...
                <form action="MainController" method="POST">
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <li>
                            ...
                            <button class="btn" type="submit" name="action" value="SearchRequestByDateInProcessRequest"/>Search
                        </li>
                    </ul>
                </form>

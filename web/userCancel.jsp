        ...
        <div class="row navbar-option col-sm-12 d-flex">
            <div class="col-sm-11">
                <div class="table table-user">
                    <table class="col-sm-12" id="myTable">
                        ...
                        <tbody>
                            <c:forEach var="request" varStatus="counter" items="${requestScope.LIST_CANCEL_REQUEST_USER}">
            ...
            <div class="navbar-col col-sm-1 order-first">
                <ul class="float-left">
                    ...
                    <li>
                        <a href="MainController?action=LoadProcessingRequest"><span class="indicator"></span><i class="fas-option active fas fa-sync-alt"><span
